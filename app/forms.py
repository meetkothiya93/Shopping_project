...
class CustomerRegisationform(UserCreationForm):
...
class MyPasswordChangeform(PasswordChangeForm):
    ...
    new_password1=forms.CharField(label=("New_Password1"),
    ...
    new_password2=forms.CharField(label=("Confirm New_Password"),
    strip=False,widget=forms.PasswordInput(attrs={'autocomplete':'new-password','class':'form-control'})),
